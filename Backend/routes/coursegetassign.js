...
app.post('/',function(req,res){
	...
	var dbo = con.db("mydb");
	var sql = "SELECT DISTINCT  CourseId, Faculty, AssignName, FileName FROM course_assignment_map WHERE Faculty =" +req.body.pname+" AND CourseId = " +req.body.cid;
	console.log(sql);
	dbo.collection("course_assignment_map").find({Faculty : req.body.pname, CourseId : req.body.cid}, {CourseId: 1, Faculty:1,  AssignName:1 , FileName: 1}).toArray(function(err2, result){
				if(err2) {
					 throw err2;
