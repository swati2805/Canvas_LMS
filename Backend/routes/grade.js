...
app.post('/',function(req,res){
   ...
   mongo.connect(url, function(err1,con) {
    ...
    var dbo = con.db("mydb");
    var sql = "SELECT DISTINCT Student, FileName FROM student_assignment_map WHERE CourseId = " +req.body.cid+" AND AssignName = " +req.body.AssignName;
    console.log(sql);
    dbo.collection("student_assignment_map").find({CourseId : req.body.cid, AssignName : req.body.AssignName}, {Student: 1, FileName:1}).toArray(function(err2, result) {
				if(err2) {
					 throw err2;
