...
class HomeS extends Component {
				...
				if(c.category === "wip") {
				  details.wip.push(
					<div 
         				...
         				<h1 class="card-title">{c.CourseId}</h1>
	...
	<form action="http://127.0.0.1:3000/home" method="post">
			...
			<div class="form-group">
				<label for="signuptype"><h4>Select a Course to View Details<span class="label label-info">Info</span></h4></label>
				<select id="signuptype" class="form-control"  onChange = {(e) => this.setState({course_selected:e.target.value, selection_done:true})} >
					<option student>Select</option>
					{options}
				</select>
			</div>			
  ...
  /*  <div class="panel panel-primary">
      <div class="panel-heading"><h3>My Courses</h3></div>
      <ul class="list-group">
        {details}
      </ul>
    </div>*/
